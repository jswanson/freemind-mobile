app.adapters.employee = (function () {
    ...
    client.invokeApi('users', { method: 'GET' }).done(function (response) {
        //alert(response.responseText);
        employees = response.result;

        console.debug("loaded employees, " + employees.length);
    ...
    var findById = function (id) {
        ...
        findByName = function (searchKey) {
            ...
            console.debug("findByName: " + searchKey);
        ...
        findByManager = function (managerId) {
            ...
            console.debug("findByManager: " + managerId);
        ...
        employees = [];
    //    { "id": 1, "firstName": "James", "lastName": "Swanson", "managerId": 0, "managerName": "", "reports": 4, "title": "President and CEO", "department": "Corporate", "cellPhone": "612-558-1972", "officePhone": "781-000-0001", "email": "jswanson@freemind.net", "city": "Eagan, MN", "pic": "james_swanson.jpg", "twitterId": "@jswanson", "blog": "http://freemind.net" },
    //    { "id": 2, "firstName": "Julie", "lastName": "Taylor", "managerId": 1, "managerName": "James Swanson", "reports": 2, "title": "VP of Marketing", "department": "Marketing", "cellPhone": "617-000-0002", "officePhone": "781-000-0002", "email": "jtaylor@fakemail.com", "city": "Boston, MA", "pic": "julie_taylor.jpg", "twitterId": "@fakejtaylor", "blog": "http://coenraets.org" },
    //    { "id": 3, "firstName": "Parker", "lastName": "Swanson", "managerId": 1, "managerName": "James Swanson", "reports": 0, "title": "CFO", "department": "Accounting", "cellPhone": "617-000-0003", "officePhone": "781-000-0003", "email": "pswanson@freemind.net", "city": "Boston, MA", "pic": "parker_swanson.jpg", "twitterId": "@fakeelee", "blog": "http://freemind.net" },
    //    { "id": 4, "firstName": "John", "lastName": "Williams", "managerId": 1, "managerName": "James Swanson", "reports": 3, "title": "VP of Engineering", "department": "Engineering", "cellPhone": "617-000-0004", "officePhone": "781-000-0004", "email": "jwilliams@fakemail.com", "city": "Boston, MA", "pic": "john_williams.jpg", "twitterId": "@fakejwilliams", "blog": "http://coenraets.org" },
    //    { "id": 5, "firstName": "Ray", "lastName": "Moore", "managerId": 1, "managerName": "James Swanson", "reports": 2, "title": "VP of Sales", "department": "Sales", "cellPhone": "617-000-0005", "officePhone": "781-000-0005", "email": "rmoore@fakemail.com", "city": "Boston, MA", "pic": "ray_moore.jpg", "twitterId": "@fakermoore", "blog": "http://coenraets.org" },
